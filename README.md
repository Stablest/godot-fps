...
- Smooth first-person movement (WASD + mouse)
- Jumping and gravity
- C# project

Note: When initializing this project you may need to create a C# solution. In godot, go to "Projects > Tools > C# > Create C# solution", or create manually.
